        ...
        <div className="w-full max-w-md px-4 sm:px-8 py-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 bg-gray-100 p-4 sm:p-5 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <button
                        type="button"
                        className="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 font-medium text-gray-700 hover:shadow-md text-sm"
                    >
