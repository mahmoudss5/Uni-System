...
export default function RegisterFrom() {
    ...
    return (
        <div className="w-full max-w-md px-8">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome to the system</h1>
                <p className="text-gray-600">Please enter your credentials to register</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-2 bg-gray-100 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <button
                        type="button"
                        className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 font-medium text-gray-700 hover:shadow-md"
                    >
