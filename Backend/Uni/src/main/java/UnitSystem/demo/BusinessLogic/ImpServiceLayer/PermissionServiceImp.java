...
public class PermissionServiceImp implements PermissionService {
        ...
        public void preventUserFromAccessingPermission(Long userId, Long permissionId) {
                ...
                log.info("preventUserFromAccessingPermission UserPermissionId={} PermissionId={}", userPermissionId,
                                permissionId);
                UserPermission userPermission = UserPermission.builder()
                                ...
                                .build();
                userPermissionsRepository.save(userPermission);
                log.info("UserPermission saved with id={} for userId={} and permissionId={}", userPermission.getId(),
                                userId, permissionId);
                return;
        }
